...
- ~~Konkrete Ausgestaltung der Design-Tokens~~ — `design/tokens.json` liegt
  vor; offen bleiben der Generator (Tokens → CSS/ANSI), das Bündeln der
  Schriften und die Wahl zwischen Lucide (ISC) und Phosphor (MIT) als
  Icon-Satz.
